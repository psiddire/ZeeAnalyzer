...
identifiedElectrons = goodZeeElectrons.clone(cut = cms.string(goodZeeElectrons.cut.value() +
                                                              ...
                                                              " && ((isEB"
                                                              " && (((0. < abs(superCluster().eta()) <=1.) && (((pfIsolationVariables().sumChargedHadronPt + max(0.0,pfIsolationVariables().sumNeutralHadronEt + pfIsolationVariables().sumPhotonEt - 0.1703 * pfIsolationVariables().sumPUPt))/p4.pt) < 0.175))"
