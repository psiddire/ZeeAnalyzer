...
config.General.requestName = 'plots_Zee_skimcut_MCv10ext1v2_withoutmatch'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_Skim_MCv10ext1v2.py'
...
config.Data.outputDatasetTag = 'Zee_ElectronPlots_skimcut_MCv10ext1v2_withoutmatch'
