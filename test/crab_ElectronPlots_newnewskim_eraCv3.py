...
config.General.requestName = 'plots_Zee_newnewskim_eraCv3'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_newnewSkim_eraCv3.py'
...
config.Data.outputDatasetTag =  'Zee_ElectronPlots_newnewskim_eraCv3'
