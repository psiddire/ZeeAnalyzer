...
config.General.requestName = 'plots_Zee_newskimcut_MCv10ext1v2_withoutmatch'
...
config.Data.outputDatasetTag = 'Zee_ElectronPlots_newskimcut_MCv10ext1v2_withoutmatch'
