...
config.General.requestName = 'plots_Zee_newnewskim_eraBv2'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_newnewSkim_v2.py'
...
config.Data.outputDatasetTag =  'Zee_ElectronPlots_newnewskim_eraBv2'
