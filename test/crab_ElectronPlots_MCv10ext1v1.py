...
config.General.requestName = 'plots_Zee_cut_MCv10ext1v1'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_MCv10ext1v1.py'
...
config.Data.outputDatasetTag = 'Zee_ElectronPlots_cut_MCv10ext1v1'
