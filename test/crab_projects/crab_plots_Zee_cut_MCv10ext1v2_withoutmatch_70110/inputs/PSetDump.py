...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('ntuple_woskim_MCv10ext1v2.root')
)
...
process.zdiElectronSequence = cms.Sequence(process.goodZeeElectrons+process.diZeeElectrons+process.diZeeElectronsFilter)
