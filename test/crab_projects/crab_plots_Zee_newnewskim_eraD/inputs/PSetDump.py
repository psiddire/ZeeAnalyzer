...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2017D/DoubleEG/MINIAOD/PromptReco-v1/000/302/031/00000/008329E5-368F-E711-A1CD-02163E01A21D.root')
)
...
process.eleIDWP = cms.PSet(
    ...
    dEtaInSeedCut = cms.vdouble(0.00523, 0.00984),
    dPhiInCut = cms.vdouble(0.159, 0.157),
    full5x5_sigmaIEtaIEtaCut = cms.vdouble(0.0128, 0.0445),
    hOverECut = cms.vdouble(0.247, 0.0982),
    missingHitsCut = cms.vint32(2, 3),
    relCombIsolationWithEACut = cms.vdouble(0.168, 0.185)
)
...
process.diZeeElectrons = cms.EDProducer("CandViewShallowCloneCombiner",
    ...
    cut = cms.string('mass > 40 && daughter(0).pt>20 && daughter(1).pt()>10'),
...
process.goodZeeElectrons = cms.EDFilter("PATElectronRefSelector",
    cut = cms.string('pt > 10 && abs(eta)<2.5'),
    src = cms.InputTag("slimmedElectrons")
)


process.identifiedElectrons = cms.EDFilter("ZElectronsSelectorAndSkim",
    absEtaMax = cms.vdouble(1.0, 1.479, 2.0, 2.2, 2.3, 
        2.4, 5.0),
    absEtaMin = cms.vdouble(0.0, 1.0, 1.479, 2.0, 2.2, 
        2.3, 2.4),
    effectiveAreaValues = cms.vdouble(0.1566, 0.1626, 0.1073, 0.0854, 0.1051, 
        0.1204, 0.1524),
    eleID = cms.PSet(
        EInverseMinusPInverseCut = cms.vdouble(0.193, 0.0962),
        dEtaInSeedCut = cms.vdouble(0.00523, 0.00984),
...
process.ntupler = cms.EDAnalyzer("ElectronPlots",
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('ntuple_newskim_eraD.root')
)
