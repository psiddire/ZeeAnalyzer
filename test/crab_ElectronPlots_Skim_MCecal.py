...
config.General.requestName = 'plots_Zee_skimcut_MCecal'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_Skim_MCecal.py'

config.Data.inputDataset = '/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer17MiniAOD-92X_upgrade2017_realistic_Candidate_forECALStudies_ext1-v1/MINIAODSIM'
...
config.Data.outputDatasetTag = 'Zee_ElectronPlots_skimcut_MCecal'
