...
config.General.requestName = 'plots_Zee_cut_MCecal'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_MCecal.py'
...
config.Data.outputDatasetTag = 'Zee_ElectronPlots_cut_MCecal'
