...
config.General.requestName = 'plots_Zee_woskim_eraBv2_70110'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_v2.py'
...
config.Data.outputDatasetTag =  'Zee_ElectronPlots_woskim_eraBv2_70110'
