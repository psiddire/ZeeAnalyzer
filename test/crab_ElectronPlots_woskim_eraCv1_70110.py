...
config.General.requestName = 'plots_Zee_woskim_eraCv1_70110'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_eraCv1.py'
...
config.Data.outputDatasetTag =  'Zee_ElectronPlots_woskim_eraCv1_70110'
