...
config.General.requestName = 'plots_Zee_woskimcut_eraD_70110'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_eraD.py'
...
config.Data.outputDatasetTag =  'Zee_ElectronPlots_woskimcut_eraD_70110'
