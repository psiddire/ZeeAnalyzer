...
config.General.requestName = 'plots_Zee_newskim_eraE_70110'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runElectronPlots_newSkim_eraE.py'
...
config.Data.outputDatasetTag =  'Zee_ElectronPlots_newskim_eraE_70110'
